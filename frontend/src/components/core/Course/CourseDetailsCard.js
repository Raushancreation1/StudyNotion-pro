      ...
      >
        ...
        <div className="px-2 sm:px-4">
          ...
          <div className="flex flex-col gap-4">
            <button
              className="bg-yellow-50 text-richblack-900 border-yellow-50 hover:bg-yellow-100 w-full rounded-md px-3 py-2 font-semibold transition-all duration-200"
              onClick={
            ...
            {(!user || !course?.studentsEnrolled.includes(user?._id)) && (
              <button onClick={handleAddToCart} className="w-full rounded-md border border-richblack-600 px-3 py-2 font-semibold text-richblack-300 hover:bg-richblack-800 transition-all duration-200">
                Add to Cart
              </button>
            )}
          </div>
