          ...
          {enrolledCourses.map((course, i, arr) => (
            ...
            >
              ...
              >
                ...
                />
                <div className="flex max-w-[220px] sm:max-w-xs flex-col gap-2">
              ...
              <div className="w-full sm:w-1/4 px-5 sm:px-2 py-1 sm:py-3">
                <p className="sm:hidden text-xs text-richblack-300 mb-1">Duration</p>
                <p>{course?.totalDuration}</p>
              </div>
              <div className="flex w-full sm:w-1/5 flex-col gap-2 px-5 sm:px-2 py-1 sm:py-3">
                <p className="sm:hidden text-xs text-richblack-300">Progress</p>
                <p>
