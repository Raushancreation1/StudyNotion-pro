...
export default function Sidebar({ isOpen = false, onClose = () => {} }) {
  ...
  return (
    <>
      ...
      <div
        className={`md:hidden fixed left-0 top-14 z-[1000] h-[calc(100vh-3.5rem)] w-[85%] max-w-xs transform border-r border-richblack-700 bg-richblack-800 transition-transform duration-300 ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-richblack-700">
          <span className="text-richblack-100 font-semibold">Dashboard</span>
          <button
            onClick={onClose}
